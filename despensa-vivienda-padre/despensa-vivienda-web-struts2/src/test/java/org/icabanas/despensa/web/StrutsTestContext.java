...
public class StrutsTestContext
{
          ...
          ServletContext servletContext) throws Exception
    {
        ...
        return dispatcher.getContainer()
           ...
           .createActionProxy(namespace, actionName, null, dispatcher.createContextMap(
                   request, response, mapping, servletContext),true,false);
    }
               ...
               Map<String, Object> sessionAttributes) throws Exception
    {
        ...
        if (requestParams != null)
        {
            ...
            {
                mockRequest.addParameter(param.getKey(),
                                              param.getValue());
            }
        }
